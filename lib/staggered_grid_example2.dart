...
class StaggeredGridExample2 extends StatelessWidget {
  const StaggeredGridExample2({
    Key? key,
                    ...
                    children: <Widget>[
                      ...
                      const Padding(
                        ...
                        child: Text(
                          ...
                          '\n'
                          'It also varies '
                          'in how wide each item is, but it cannot optimize '
                          'such a layout, as far as I am aware at least. With '
                          'some column amounts and item widths it may also '
                          'create layouts where panels are cut '
                          'in this layout scenario, so it is not really so '
                          'well supported.',
                        ),
                      ),
                    ],
